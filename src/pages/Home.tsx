...
import image2 from "../assets/imaimport { useEffect } from "react";
import { Slide } from "react-slideshow-image";
import "react-slideshow-image/dist/styles.css";
import { useMediaQuery } from "react-responsive";
import image1 from "../assets/image1.png";
...
const Home = () => {
  ...
  return (
    <div className="text-center text-lg md:text-xl px-4">
      <p className="m-6 md:m-10 font-bold text-4xl md:text-6xl">CapPack</p>
      <p className="m-6 md:m-10 font-semibold text-xl md:text-2xl">
      ...
      <div className="m-6 md:m-10">
        ...
        <p>
          <b>Java:</b> 1.6.1 - 1.21.11
        </p>
        <p>
          <b>Bedrock:</b> 1.21.130
        </p>
      </div>
      <div className="m-6 md:m-10">
      ...
      {isMobile ? (
        <>
          ...
          <div className="my-8 mx-4 font-semibold text-2xl md:text-4xl p-6">
      ...
      {isMobile ? (
        <div className="my-8 mx-4 flex flex-col">
          <div className="w-full flex justify-center items-center font-semibold text-center text-2xl md:text-4xl p-6">
