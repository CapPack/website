const downloadsData = {
  ...
  v6: {
    "Bedrock 1.14.60":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v6/Bedrock.1.14.60.CapPack.v6-r1.mcpack",
    "1.15 - 1.16.1":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v6/1.15.-.1.16.1.CapPack.v6-r1.zip",
    "1.13 - 1.14.4":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v6/1.13.-.1.14.4.CapPack.v6-r1.zip",
    "1.11 - 1.12.2":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v6/1.11.-.1.12.2.CapPack.v6-r1.zip",
    "1.9 - 1.10.2":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v6/1.9.-.1.10.2.CapPack.v6-r1.zip"
  },
  v5: {
    "Bedrock 1.14.60":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v5/Bedrock.1.14.60.CapPack.v5-r1.mcpack",
    "1.15 - 1.16.1":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v5/1.15.-.1.16.1.CapPack.v5-r1.zip",
    "1.13 - 1.14.4":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v5/1.13.-.1.14.4.CapPack.v5-r1.zip",
    "1.11 - 1.12.2":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v5/1.11.-.1.12.2.CapPack.v5-r1.zip",
    "1.9 - 1.10.2":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v5/1.9.-.1.10.2.CapPack.v5-r1.zip"
  },
  v4: {
    "Bedrock 1.14.60":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v4/Bedrock.1.14.60.CapPack.v4-r1.mcpack",
    "1.15 - 1.16.1":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v4/1.15.-.1.16.1.CapPack.v4-r1.zip",
    "1.13 - 1.14.4":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v4/1.13.-.1.14.4.CapPack.v4-r1.zip",
    "1.11 - 1.12.2":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v4/1.11.-.1.12.2.CapPack.v4-r1.zip",
    "1.9 - 1.10.2":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v4/1.9.-.1.10.2.CapPack.v4-r1.zip"
  },
  v3: {
    "Bedrock 1.14.60":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v3/Bedrock.1.14.60.CapPack.v3-r1.mcpack",
    "1.15 - 1.16.1":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v3/1.15.-.1.16.1.CapPack.v3-r1.zip",
    "1.13 - 1.14.4":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v3/1.13.-.1.14.4.CapPack.v3-r1.zip",
    "1.11 - 1.12.2":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v3/1.11.-.1.12.2.CapPack.v3-r1.zip",
    "1.9 - 1.10.2":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v3/1.9.-.1.10.2.CapPack.v3-r1.zip"
  },
  v2: {
    "Bedrock 1.14.30":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v2/Bedrock.1.14.30.CapPack.v2-r1.mcpack",
    "1.15 - 1.16.1":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v2/1.15.-.1.16.1.CapPack.v2-r1.zip",
    "1.13 - 1.14.4":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v2/1.13.-.1.14.4.CapPack.v2-r1.zip",
    "1.11 - 1.12.2":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v2/1.11.-.1.12.2.CapPack.v2-r1.zip"
  },
  v1: {
    "Bedrock 1.14.30":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v1/Bedrock.1.14.30.CapPack.v1-r1.mcpack",
    "1.15 - 1.16.1":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v1/1.15.-.1.16.1.CapPack.v1-r1.zip",
    "1.13 - 1.14.4":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v1/1.13.-.1.14.4.CapPack.v1-r1.zip",
    "1.11 - 1.12.2":
      "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/download/v1/1.11.-.1.12.2.CapPack.v1-r1.zip"
  }
};

const releaseOrder = Object.keys(downloadsData);
const latestRelease = releaseOrder[0];
...
function releaseMarkup(release, links, showTitle = true) {
  const chips = Object.entries(links)
    .map(
      ([version, url]) =>
        `<a class="download-chip" href="${url}">${version}</a>`
    )
    .join("");
  const title = showTitle ? `<h2 class="release-heading">${release}</h2>` : "";
...
function releaseActionsMarkup(release, includeLatestExtras) {
  const githubLink = includeLatestExtras
    ? "https://github.com/CapPack/the-captainsparklez-texture-pack/releases/latest"
    : `https://github.com/CapPack/the-captainsparklez-texture-pack/releases/tag/${release}`;
  const latestExtras = includeLatestExtras
    ? `
      <a href="https://www.curseforge.com/minecraft/texture-packs/the-captainsparklez-texture-pack" target="_blank" rel="noopener noreferrer">
        <img src="src/assets/DlOnCurseforge.png" alt="Download on CurseForge" />
      </a>
      <a href="https://modrinth.com/resourcepack/the-captainsparklez-texture-pack" target="_blank" rel="noopener noreferrer">
        <img src="src/assets/DlOnModrinth.png" alt="Download on Modrinth" />
      </a>
      <a href="https://www.planetminecraft.com/texture-pack/the-captainsparklez-texture-pack/" target="_blank" rel="noopener noreferrer">
        <img src="src/assets/DlOnPlanetMinecraft.png" alt="Download on Planet Minecraft" />
      </a>
    `
    : "";

  return `
    <div class="platform-row release-actions">
      <a href="${githubLink}" target="_blank" rel="noopener noreferrer">
        <img src="src/assets/DlOnGitHub.png" alt="Download ${release} on GitHub" />
      </a>
      ${latestExtras}
    </div>
  `;
...
function setupDownloadsPage() {
  const latestView = document.getElementById("latest-release-view");
  const allView = document.getElementById("all-releases-view");
  if (!latestView || !allView) return;

  latestView.innerHTML = `
    <p class="release-heading">Current latest release: ${latestRelease}</p>
    ${releaseMarkup(latestRelease, downloadsData[latestRelease], false)}
    <div class="platform-row">
      <a href="https://github.com/CapPack/the-captainsparklez-texture-pack/releases/latest" target="_blank" rel="noopener noreferrer">
        <img src="src/assets/DlOnGitHub.png" alt="Download on GitHub" />
      </a>
      <a href="https://www.curseforge.com/minecraft/texture-packs/the-captainsparklez-texture-pack" target="_blank" rel="noopener noreferrer">
        <img src="src/assets/DlOnCurseforge.png" alt="Download on CurseForge" />
      </a>
  ...
  allView.innerHTML = releaseOrder
    .map((release) => {
      return `${releaseMarkup(release, downloadsData[release])}${releaseActionsMarkup(release, release === latestRelease)}`;
    })
    .join("");
  ...
  modeButtons.forEach((button) => {
    button.addEventListener("click", () => {
      const isLatest = button.dataset.mode === "latest";
      modeButtons.forEach((candidate) => candidate.classList.remove("active"));
      button.classList.add("active");
      latestView.classList.toggle("hidden", !isLatest);
      allView.classList.toggle("hidden", isLatest);
    });
  });
}
